...
class TodoSpec : DescribeSpec({
    describe("Todo") {
        ...
        it("with start time and duration computes correctly") {
        ...
        it("teamIds defaults to empty list") {
            val todo = Todo(title = "No teams")
            todo.teamIds shouldBe emptyList()
        }

        it("can be created with team associations") {
